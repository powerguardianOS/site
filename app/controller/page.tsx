    ...
    <div className="space-y-10">
      ...
      <section className="space-y-4">
        ...
        <p className="text-sm md:text-base text-zinc-400 max-w-2xl">
          Controller OS is where you adopt connectors, map UPS devices to hosts
          and racks, define shutdown rules and manage credentials and updates.
          Think of it as the central brain for your power layer.
        </p>
      ...
      <section className="grid gap-6 md:grid-cols-2">
        ...
        {/* VLAN & network design card */}
        <div className="rounded-xl border border-zinc-800 bg-zinc-950/70 p-6 space-y-3">
          <h3 className="text-sm font-semibold text-zinc-200 uppercase tracking-[0.18em]">
            VLAN &amp; network design
          </h3>
          <p className="text-sm text-zinc-400">
            Love clean network segmentation? PowerGuardian has you covered. In
            the default setup, LAN1 behaves like a normal network interface on
            your LAN. As long as Controller OS lives in the same network
            segment, it can discover Connectors and UPS management cards
            automatically (manual add is still possible when needed).
          </p>
          <ul className="space-y-1 text-sm text-zinc-400 mt-3">
            <li>
              • <span className="font-medium">Simple mode:</span> LAN1 on your
              main LAN, discovering Connectors and UPS management cards in the
              same subnet.
            </li>
            <li>
              • <span className="font-medium">VLAN-aware mode:</span> Controller
              OS understands tagged and untagged traffic, so you can present
              multiple VLANs on a single port from your switch.
            </li>
            <li>
              • <span className="font-medium">Dual-NIC setups:</span> use LAN1
              for your regular LAN and LAN2 for an isolated network, for example
              an IoT / UPS management segment.
            </li>
          </ul>
          <p className="text-xs text-zinc-500 mt-3">
            The idea is simple: keep your power-control layer reachable and
            cleanly segmented, even when the rest of the network is noisy, under
            maintenance or being reconfigured.
          </p>
        </div>
      </section>
      ...
      <section className="rounded-xl border border-zinc-800 bg-zinc-950/70 p-6 space-y-4">
        ...
        <div className="grid gap-4 md:grid-cols-3 text-sm text-zinc-400">
          ...
          <div>
            ...
            <p className="text-xs text-zinc-500">
              Keep core services and primary storage alive longer than dev boxes
              or non-critical systems.
            </p>
          </div>
          <div>
            <h3 className="text-xs font-semibold text-zinc-200 mb-1">
