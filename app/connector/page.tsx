    ...
    <div className="max-w-5xl mx-auto px-6">
      ...
      <section className="py-28 grid lg:grid-cols-2 gap-16 items-center">
        <div className="space-y-6">
          ...
          <h1 className="pg-display text-5xl md:text-6xl text-white">
            The edge agent<br /><em className="text-zinc-400">next to your UPS.</em>
          </h1>
        ...
        {/* Specs card */}
        <div className="rounded-2xl border border-white/[0.08] bg-gradient-to-b from-white/[0.02] to-transparent p-6 font-mono text-sm space-y-2.5">
      ...
      <section className="py-24 space-y-12">
        <div className="space-y-3">
          ...
          <h2 className="pg-display text-4xl md:text-5xl text-white">What Connector OS does</h2>
        </div>
      ...
      <section className="py-20">
        <div className="rounded-2xl border border-white/[0.08] bg-gradient-to-b from-white/[0.02] to-transparent p-8 flex flex-col md:flex-row items-start md:items-center justify-between gap-6">
          <div className="space-y-1">
            <h2 className="pg-display text-2xl md:text-3xl text-white">Ready to deploy your first connector?</h2>
